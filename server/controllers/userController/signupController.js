...
// const logo = require('../../../client/src/assets/logo1.png')
...
const generateAndSendOtp = async (email) =>{
  try{
    ...
    var mailOptions = {
      from: '"AlumniLink" <' + process.env.SMTP_MAIL + '>',
      to: email,
      subject: "Your OTP for Alumni Link Verification",
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 8px; background-color: #f9f9f9;">
      ...
      <p style="color: #555; line-height: 1.6;">
        Thank you for choosing <strong>Alumni Link</strong>! We're thrilled to have you on board. Here is your OTP for verification:
      </p>
